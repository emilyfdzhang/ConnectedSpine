 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(R,W){var M=R.length;R.push(W);e:for(;0<M;){var J=M-1>>>1,P=R[J];if(0<i(P,W))R[J]=W,R[M]=P,M=J;else break e}}function n(R){return R.length===0?null:R[0]}function r(R){if(R.length===0)return null;var W=R[0],M=R.pop();if(M!==W){R[0]=M;e:for(var J=0,P=R.length,F=P>>>1;J<F;){var O=2*(J+1)-1,H=R[O],x=O+1,ie=R[x];if(0>i(H,M))x<P&&0>i(ie,H)?(R[J]=ie,R[x]=M,J=x):(R[J]=H,R[O]=M,J=O);else if(x<P&&0>i(ie,M))R[J]=ie,R[x]=M,J=x;else break e}}return W}function i(R,W){var M=R.sortIndex-W.sortIndex;return M!==0?M:R.id-W.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var s=Date,a=s.now();e.unstable_now=function(){return s.now()-a}}var l=[],c=[],u=1,d=null,f=3,h=!1,p=!1,y=!1,S=typeof setTimeout=="function"?setTimeout:null,v=typeof clearTimeout=="function"?clearTimeout:null,m=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(R){for(var W=n(c);W!==null;){if(W.callback===null)r(c);else if(W.startTime<=R)r(c),W.sortIndex=W.expirationTime,t(l,W);else break;W=n(c)}}function _(R){if(y=!1,g(R),!p)if(n(l)!==null)p=!0,X(C);else{var W=n(c);W!==null&&se(_,W.startTime-R)}}function C(R,W){p=!1,y&&(y=!1,v(T),T=-1),h=!0;var M=f;try{for(g(W),d=n(l);d!==null&&(!(d.expirationTime>W)||R&&!D());){var J=d.callback;if(typeof J=="function"){d.callback=null,f=d.priorityLevel;var P=J(d.expirationTime<=W);W=e.unstable_now(),typeof P=="function"?d.callback=P:d===n(l)&&r(l),g(W)}else r(l);d=n(l)}if(d!==null)var F=!0;else{var O=n(c);O!==null&&se(_,O.startTime-W),F=!1}return F}finally{d=null,f=M,h=!1}}var k=!1,E=null,T=-1,A=5,I=-1;function D(){return!(e.unstable_now()-I<A)}function q(){if(E!==null){var R=e.unstable_now();I=R;var W=!0;try{W=E(!0,R)}finally{W?V():(k=!1,E=null)}}else k=!1}var V;if(typeof m=="function")V=function(){m(q)};else if(typeof MessageChannel<"u"){var $=new MessageChannel,N=$.port2;$.port1.onmessage=q,V=function(){N.postMessage(null)}}else V=function(){S(q,0)};function X(R){E=R,k||(k=!0,V())}function se(R,W){T=S(function(){R(e.unstable_now())},W)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(R){R.callback=null},e.unstable_continueExecution=function(){p||h||(p=!0,X(C))},e.unstable_forceFrameRate=function(R){0>R||125<R?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<R?Math.floor(1e3/R):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_getFirstCallbackNode=function(){return n(l)},e.unstable_next=function(R){switch(f){case 1:case 2:case 3:var W=3;break;default:W=f}var M=f;f=W;try{return R()}finally{f=M}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(R,W){switch(R){case 1:case 2:case 3:case 4:case 5:break;default:R=3}var M=f;f=R;try{return W()}finally{f=M}},e.unstable_scheduleCallback=function(R,W,M){var J=e.unstable_now();switch(typeof M=="object"&&M!==null?(M=M.delay,M=typeof M=="number"&&0<M?J+M:J):M=J,R){case 1:var P=-1;break;case 2:P=250;break;case 5:P=1073741823;break;case 4:P=1e4;break;default:P=5e3}return P=M+P,R={id:u++,callback:W,priorityLevel:R,startTime:M,expirationTime:P,sortIndex:-1},M>J?(R.sortIndex=M,t(c,R),n(l)===null&&R===n(c)&&(y?(v(T),T=-1):y=!0,se(_,M-J))):(R.sortIndex=P,t(l,R),p||h||(p=!0,X(C))),R},e.unstable_shouldYield=D,e.unstable_wrapCallback=function(R){var W=f;return function(){var M=f;f=W;try{return R.apply(this,arguments)}finally{f=M}}}})(yb);(function(e){e.exports=yb})(y2);/**
 * @license React
...
`,S6=j.span`
  ...
  font-size: 25px;
  cursor: pointer;
`,hi=({showModal:e,setShowModal:t,text:n})=>b(b6,{showModal:e,children:L("div",{children:[b(S6,{onClick:()=>t(!1),children:"×"}),n]})}),ec="0px 2px 4px rgba(0, 0, 0, 0.2)",tc="rgba(255, 255, 255, 0.8)",Cy="1px solid rgba(0, 0, 0, 0.12)",Us="#3a49ac",C6="#f2f2f2",E6="#b3b3b3",k6="#b3acaa",gf="rgba(179, 172, 170, 0.5)",Cl="#1d2556",Jx="#3a49ac",dd="rgba(58, 73, 172, 0.2)",Vm=j.button`
  width: 80px;
  height: 40px;
...
`,P9=()=>{const{setAssessmentState:e}=w.useContext(Fe),{setIsLogedIn:t}=w.useContext(Fe),{prevPage:n,setPrevPage:r}=w.useContext(Fe),[i,o]=w.useState(""),[s,a]=w.useState(""),[l,c]=w.useState(!1),[u,d]=w.useState(!1),[f,h]=w.useState(""),[p,y]=w.useState(""),[S,v]=w.useState(!1);return L(yi,{image:"../../results.jpg",children:[b(po,{}),L(lo,{children:[L(BC,{login:1,children:[b(eI,{showAlert:S,setShowAlert:v,title:p,alert:f}),b(T9,{children:"Login"}),b(BI,{login:1,email:i,changeEmail:g=>o(g.target.value),password:s,changePassword:g=>a(g.target.value),showPassword:l,changeShowPassword:()=>c(!l)}),b(Zx,{login:1,onClick:async g=>{g.preventDefault();try{const _=await wM(_x,i,s);t(!0),n==="profile"?(e("profile"),r("")):e("zipcode")}catch{v(!0),h("Please enter a correct email and password."),y("Error");return}},children:"Login"}),b(iv,{onClick:()=>d(!0),children:"Why do we require this?"}),b(hi,{showModal:u,setShowModal:d,text:k9}),L(R9,{children:[b("p",{children:"Or Sign Up Using"}),b("a",{onClick:()=>{e("signup")},children:"Sign up"})]})]}),b(UC,{children:b(Oa,{onClick:()=>{e("home")},children:"Back"})})]})]})},A9=j.a`
  cursor: pointer;
  text-decoration: none;
  font-weight: 300;
  color: black;
...
`,z9=j.p`
  font-weight: 100;
`,U9=()=>{const{setAssessmentState:e}=w.useContext(Fe),{isLogedIn:t}=w.useContext(Fe);return L(yi,{image:"../../homepage.jpg",children:[b(po,{}),L(lo,{children:[L($9,{children:[b("h1",{children:"We connect you to the care you need."}),b("p",{children:"ConnectedSpine uses the knowledge of spine care specialists to guide you to the right providers."})]}),L(F9,{children:[b(z9,{children:"Experiencing pain or discomfort in your back or neck?"}),b("p",{children:b(Qo,{children:"Take our 5 min assessment."})}),b("button",{onClick:()=>{e(t?"zipcode":"login")},children:"Start Assessment"})]})]})]})},B9=({user:e})=>{const[t,n]=w.useState({question1:"",question2:"",question3:0,question4:"",question5:0}),[r,i]=w.useState(!1),[o,s]=vl(`/users/${e.uid}`),a=u=>{u.preventDefault(),o({feedback:t}),i(!0)},l=()=>{n({question1:"",question2:"",question3:0,question4:"",question5:0}),i(!1)},c=u=>{const{name:d,value:f,type:h}=u.target,p=h==="number"?parseInt(f):f;n(y=>({...y,[d]:p}))};return b("div",{style:{maxWidth:"400px",margin:"0 auto"},children:r?L("div",{children:[b("h2",{children:"Thank you for your feedback!"}),b("p",{children:"We appreciate your input."}),b("button",{style:{display:"block",margin:"0 auto"},onClick:l,children:"Submit Another Feedback"})]}):L("form",{onSubmit:a,style:{backgroundColor:"#f7f7f7",padding:"20px",borderRadius:"5px"},children:[b("h2",{style:{textAlign:"center"},children:"Feedback Form"}),L("label",{style:{display:"block",marginBottom:"10px"},children:["Did you use the advice of the app? Please answer yes or no.",L("select",{name:"question1",value:t.question1,onChange:c,required:!0,style:{width:"100%",padding:"5px",marginTop:"5px"},children:[b("option",{value:"",children:"Select an option"}),b("option",{value:"Yes",children:"Yes"}),b("option",{value:"No",children:"No"})]})]}),L("label",{style:{display:"block",marginBottom:"10px"},children:["What provider did you see?",L("select",{name:"question2",value:t.question2,onChange:c,required:!0,style:{width:"100%",padding:"5px",marginTop:"5px"},children:[b("option",{value:"",children:"Select an option"}),b("option",{value:"Primary care physician",children:"Primary care physician"}),b("option",{value:"Neurosurgeon",children:"Neurosurgeon"}),b("option",{value:"ER/Urgent Care",children:"ER/Urgent Care"}),b("option",{value:"Neurologist",children:"Neurologist"}),b("option",{value:"Interventional pain physician",children:"Interventional pain physician"})]})]}),L("label",{style:{display:"block",marginBottom:"10px"},children:["How useful was this provider on a scale from 0-10?",L("div",{style:{display:"flex",alignItems:"center"},children:[b("span",{style:{marginRight:"10px"},children:"0"}),b("input",{type:"range",name:"question3",min:"0",max:"10",value:t.question3,onChange:c,required:!0,style:{flex:"1",marginTop:"5px"}}),b("span",{style:{marginLeft:"10px"},children:"10"})]})]}),L("label",{style:{display:"block",marginBottom:"10px"},children:["Would you recommend this app to a colleague? Please answer yes or no.",L("select",{name:"question4",value:t.question4,onChange:c,required:!0,style:{width:"100%",padding:"5px",marginTop:"5px"},children:[b("option",{value:"",children:"Select an option"}),b("option",{value:"Yes",children:"Yes"}),b("option",{value:"No",children:"No"})]})]}),L("label",{style:{display:"block",marginBottom:"10px"},children:["How much relief have you gotten on a scale from 0 - 100%?",L("div",{style:{display:"flex",alignItems:"center"},children:[b("span",{style:{marginRight:"10px"},children:"0%"}),b("input",{type:"range",name:"question5",min:"0",max:"100",value:t.question5,onChange:c,required:!0,style:{flex:"1",marginTop:"5px"}}),b("span",{style:{marginLeft:"10px"},children:"100%"})]})]}),b("button",{style:{display:"block",margin:"0 auto",padding:"10px 20px",backgroundColor:"#4caf50",color:"#fff",border:"none",borderRadius:"4px",cursor:"pointer"},type:"submit",children:"Submit Feedback"})]})})},j9=j.h3`
  font-size: 16px;
  font-weight: 300;
  line-height: 24px;
  text-transform: uppercase;
...
`,H9=j.h1`
  ...
  line-height: 40px;
  letter-spacing: 0px;
`,V9=()=>{w.useContext(Fe);const e=Fs().currentUser;return L(yi,{image:"../../results.jpg",children:[b(po,{}),b(lo,{children:L($C,{children:[L(zC,{children:[b(j9,{children:"Profile Page"}),b(W9,{children:e.email}),b(H9,{children:"Provide feedback on ConnectedSpine's process"}),b("br",{})]}),b(FC,{children:b(B9,{user:e})})]})})]})},q9="#979797",G9=j.h1`
  font-size: 32px;
  font-weight: 300;
  line-height: 40px;
  max-width: 50%;
...
`,lj=()=>{const{isValid:e,setIsValid:t}=w.useContext(Fe),{selectedOptions:n,setSelectedOptions:r}=w.useContext(Fe),{answers:i,setAnswers:o}=w.useContext(Fe),[s,a]=w.useState(""),l=c=>{a(c),r(c)};return w.useEffect(()=>{i.identity&&(s&&s!=i.identity?r(s):r(i.identity)),t(!!(s||n))},[s,t]),L(aj,{children:[b(bd.Provider,{value:{color:`${ab}`,size:"50px"},children:b(lb,{selected:n==="myself",onClick:()=>l("myself"),children:L("div",{children:[b(ij,{}),"Myself"]})})}),b(bd.Provider,{value:{color:`${ab}`,size:"70px"},children:b(lb,{selected:n==="others",onClick:()=>l("others"),children:L("div",{children:[b(oj,{}),"Someone Else"]})})})]})},cj=j.div`
  width: 70%;
  margin: -50px auto 0;
`,uj=j.div`
  margin-bottom: 15px;
...
`,gj=j.div`
  ...
  border-radius: 50%;
  background-color: ${Us};
`,vj=({options:e,selectedOptions:t,HandleOnclick:n})=>L(hj,{children:[e.map((r,i)=>L(pj,{value:r,onClick:n,children:[b(mj,{id:i,selected:t.includes(r),value:r,children:t.includes(r)&&b(gj,{})}),b("div",{children:r})]},`select-${i}`))," "]}),yj=j.div`
  width: 80%;
`,_j=j.label`
  display: flex;
  flex-direction: row;
...
`,wj=j.div`
  margin-left: 15px;
`,bj=({options:e,selectedOptions:t,HandleOnclick:n})=>b(yj,{role:"group","aria-label":"Button group",children:e.map((r,i)=>L(_j,{children:[b("input",{type:"checkbox",id:i,value:r,checked:t.includes(r),onChange:n}),b(wj,{children:r})]},`select-${i}`))}),Sj=({options:e,selectedOptions:t,HandleOnclick:n})=>b("div",{children:e.map((r,i)=>b(fd,{value:r,id:i,onClick:n,selected:t.includes(r),children:r},`button-${i}`))}),Cj=j.div`
  display: flex;
  flex-direction: column;
...
`,Bj=j.button`
  ...
  text-transform: uppercase;
  color: white;
`,jj=({icon:e,provider:t,bold:n,text:r})=>{const[i,o]=w.useState(!1);return L(Lj,{children:[b(Dj,{children:b(mr,{icon:e})}),L($j,{children:[b(zj,{children:t}),L(Uj,{children:[b(Qo,{children:n}),r]}),b(Fj,{onClick:()=>o(!0),children:"+ More details"}),b(hi,{showModal:i,setShowModal:o,text:"hey"}),b(Bj,{children:"Search Providers"})]})]})},Wj=j.div`
  margin: 0 auto;
  width: 60%;
  margin-top: -90px;
`,Hj=j.h2`
